...
export function Footer() {
    ...
    <div className="mx-auto max-w-screen-xl px-4 pt-16 pb-8 sm:px-6 lg:px-8">
        ...
        <form className="mt-6">
           ...
           <Button className="absolute end-1 top-1/2 -translate-y-1/2 rounded-full bg-lime-600 px-5 py-3 text-sm font-medium text-white transition hover:bg-lime-700">Subscribe</Button>
